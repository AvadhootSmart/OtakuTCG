...
export function CardPack({ pack, variant = 'marketplace', onOpen }: CardPackProps) {
    ...
    const accentStyles = {
        ...
        purple: "from-purple-600 to-pink-500 border-purple-500/50 shadow-purple-500/20",
        amber: "from-amber-500 to-yellow-400 border-amber-500/50 shadow-amber-500/20",
    }[pack.accentColor as "blue" | "purple" | "amber"] || "from-slate-500 to-slate-400 border-slate-500/50 shadow-slate-500/20";

    return (
        <div className="w-full max-w-[320px] h-full">
            <div className={`h-full rounded-2xl border-2 bg-card overflow-hidden flex flex-col shadow-xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-2 ${accentStyles}`}>
                ...
                <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute bottom-4 left-4">
                        <span className="bg-foreground text-background px-2 py-1 rounded text-[10px] font-black uppercase tracking-widest flex items-center gap-1 shadow-lg">
                ...
                <div className="p-5 flex-1 flex flex-col gap-4">
                    <div>
                        <h3 className="text-xl font-black rock-salt mb-1 line-clamp-1">{pack.name}</h3>
                    ...
                    <div className="mt-auto space-y-4 pt-2 border-t border-border/40">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-lg font-black tabular-nums">{pack.price}</span>
                            </div>
                            <CardsPopup packName={pack.name}>
