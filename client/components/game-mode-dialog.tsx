...
import { Trophy, Cpu, Zap, Sparkles } from "lucide-react";
...
const modes = [
    ...
    {
        title: "Dispatch",
        description: "Send your units on automated missions to gather resources and experience while you're away.",
        icon: Zap,
                ...
                <div className="p-8">
                    <DialogHeader className="mb-8">
                        <div className="flex items-center justify-center space-x-2 mb-2">
                            ...
                            <span className="text-xs font-bold tracking-[0.3em] text-blue-400 uppercase">Mission Control</span>
                        </div>
                        ...
                        {modes.map((mode) => (
                            ...
                            >
                                <div className="relative h-full flex flex-col p-6 rounded-2xl bg-[#0a0a0a] border border-white/5 group-hover:border-white/20 transition-all duration-500">
                                    <div className={`w-14 h-14 rounded-xl mb-6 flex items-center justify-center bg-gradient-to-br ${mode.color} shadow-lg transform group-hover:rotate-12 transition-transform duration-500`}>
                                    ...
                                    <Link href={mode.href} className="mt-auto">
                                        <button className={`w-full py-3 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 group-hover:border-white/20 text-xs font-bold tracking-widest uppercase transition-all duration-300 flex items-center justify-center space-x-2`}>
                                            <span>Deploy</span>
                                            <div className={`w-1 h-1 rounded-full bg-white opacity-0 group-hover:opacity-100 group-hover:animate-ping`} />
                                        </button>
                                    </Link>
                                </div>
                            </motion.div>
